...
impl FindBy {
    pub fn slug(slug: String) -> FindBy {
        FindBy(FindByCriteria::SLUG(slug))
    }
    pub fn id(id: PostId) -> FindBy {
        FindBy(FindByCriteria::ID(id))
    }
}
