                ...
                actix_web::web::scope("/admin")
                    ...
                    .service(
                        actix_web::web::scope("/drafts")
                            ...
                            .service(actix_web::web::resource("/{draft_id}").route(actix_web::web::get().to(web::admin::draft)))
                            .service(actix_web::web::resource("/{draft_id}").route(actix_web::web::post().to(web::admin::draft)))
                            .service(actix_web::web::resource("/{draft_id}/preview").route(actix_web::web::get().to(web::admin::preview_draft)))
                            .service(actix_web::web::resource("/{draft_id}/publish").route(actix_web::web::post().to(web::admin::draft)))
                            .service(actix_web::web::resource("/{draft_id}/make-public").route(actix_web::web::post().to(web::admin::draft)))
